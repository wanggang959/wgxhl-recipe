...
(
    ...
    birthday date comment '公历生日',
    birthday_calendar varchar(20) not null default 'SOLAR' comment '生日历法：SOLAR-公历，LUNAR-农历',
    lunar_birthday_year int comment '农历出生年',
    lunar_birthday_month tinyint comment '农历生日月份',
    lunar_birthday_day tinyint comment '农历生日日期',
    lunar_birthday_leap tinyint(1) not null default 0 comment '是否农历闰月',
    user_role varchar(32) comment '用户角色',
    status varchar(32) comment '状态',
    remark varchar(500) comment '备注',
    notification_preference varchar(50) comment '通知偏好',
...
create table special_expense_project
(
    id varchar(36) not null comment '主键id',
...
create table special_expense_item
(
    id varchar(36) not null comment '主键id',
